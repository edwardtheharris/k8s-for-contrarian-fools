...
date: 2025-09-30
title: Kubernetes the Hard Way Glossary
---
...
F5
  [F5](https://www.f5.com/) is industry’s premier platform. The industry is
  presumably "tech" and the platform is presumably "networks?" on the Internet.
...
NGINX Ingress
  ...
  is an Ingress Controller implementation for NGINX that can load
  balance Websocket, gRPC, TCP and UDP applications.
