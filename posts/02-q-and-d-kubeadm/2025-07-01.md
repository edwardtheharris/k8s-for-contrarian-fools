...
[certs] apiserver serving cert is signed for DNS names \
  ...
  kubernetes.default.svc.cluster.local marius] and IPs \
...
[mark-control-plane] Marking the node marius as control-plane by
  adding the labels: [
...
NAME     STATUS   ROLES           AGE   VERSION
marius   Ready    control-plane   21m   v1.33.2
```
